/*
  ...
  - You are about to drop the column `inputColumn` on the `boards` table. All the data in the column will be lost.
  - You are about to drop the column `nextBoardId` on the `boards` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `boards` DROP COLUMN `inputColumn`,
    DROP COLUMN `nextBoardId`;
